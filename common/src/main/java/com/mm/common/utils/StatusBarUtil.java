...
public class StatusBarUtil {
     ...
     */
    public static void setPaddingTop(Fragment fragment, @NonNull View view) {
        setPaddingTop(fragment.getContext(), view);
    }
    ...
    public static int getStatusBarHeight() {
        Activity mActivity = ActivityDelegate.delegate.get().getActivity();
        return getStatusBarHeight(mActivity);
    }
