...
public class StatusViewBuilder {
    ...
    public void setEmptyRetryClickListener(View.OnClickListener clickListener) {
        this.emptyRetryClickListener = clickListener;
    }

    public void setErrorRetryClickListener(View.OnClickListener clickListener) {
        this.errorRetryClickListener = clickListener;
    }
    ...
    public static class Builder {
        ...
        public StatusViewBuilder defaultBuild() {
            this.loadingTip = context.getString(R.string.text_loading);
            this.emptyTip = context.getString(R.string.text_empty);
            this.errorTip = context.getString(R.string.text_error);
            this.tipColor = ContextCompat.getColor(context, R.color.color_tip);
            this.tipSize = 13;
            this.emptyIcon = 0;
            this.errorIcon = 0;
            this.emptyRetryText = context.getString(R.string.text_retry);
            this.errorRetryText = context.getString(R.string.text_retry);
            this.retryColor = ContextCompat.getColor(context, R.color.color_retry);
            this.retrySize = 14;
            this.retryDrawable = R.drawable.retry_background;
            return new StatusViewBuilder(this);
        }
    }
}
